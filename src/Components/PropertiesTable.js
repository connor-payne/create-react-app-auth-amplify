      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="center">TAG QUANTITY</StyledTableCell>
            <StyledTableCell align="center"></StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {props.properties.map((row, key) => (
            <TableRow key={row.propertyAddress}>
              <TableCell component="th" scope="row">
                {row.propertyAddress}
              </TableCell>
              <TableCell align="center">{row.propertyState}</TableCell>
              <TableCell align="center">{row.lastServiceDate == "0" ? "N/A" : row.lastServiceDate}</TableCell>
              <TableCell align="center">{props.tagMap && props.tagMap[row.id] ? props.tagMap[row.id].length : 0}</TableCell>
              <TableCell align="center" style={{color:'#637FFD', fontWeight:'bold'}}><NavLink to={'/properties/' + row.id} style={{ color:'#637FFD', textDecoration: 'none'}} activeStyle={{color:'#637FFD',textDecoration: 'none'}}>View Tags</NavLink></TableCell>
            </TableRow>
          ))}
          <TableRow>
          <TableCell component="th" scope="row">
